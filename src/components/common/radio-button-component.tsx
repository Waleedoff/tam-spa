    ...
    <div dir={props.dir}>
      ...
      >
        <input
          ...
          type="radio"
          name="toggle"
          className={`appearance-none ${getSizes()} grid place-items-center rounded-full border-[1px] ${getColor()} before:scale-0 before:rounded-full before:transition-transform before:ease-in-out checked:before:scale-[1px]`}
        />
        {t(`${label}`)}
      </label>
    </div>
